...
def concatenate_together(args):
	...
	filetypes = np.array([np.tile(["scb"], len(args.scb)), np.tile(["sscb"], len(args.sscb)), np.tile(["sstb"], len(args.sstb)), np.tile(["scco"], len(args.sstb)), np.tile(["scto"], len(args.scto)), np.tile(["sscco"], len(args.sscco)), np.tile(["sstto"], len(args.sstto)), np.tile(["ncb"], len(args.ncb)), np.tile(["nscb"], len(args.nscb)), np.tile(["nstb"], len(args.nstb)), np.tile(["ncco"], len(args.ncco)), np.tile(["ncto"], len(args.ncto)), np.tile(["nscco"], len(args.nscco)), np.tile(["nstto"], len(args.nstto))]).flatten()
