...
def concatenate_together(args):
	newarr = pd.DataFrame()
	files = np.flatten([args.scb, args.sscb, args.sstb, args.scco, args.scto, args.sscco, args.sstto, args.ncb, args.nscb, args.nstb, args.ncco, args.ncto, args.nscco, args.nstto])
