...
def main():
    ...
    for g in ['mm10', 'hg38']:
        ...
        for i in range(data.shape[0]):
            ...
            X[-1] += (numpy.random.random() - 0.5) * 0.75
    ...
    ax.text(5, -0.15, "CREs", horizontalalignment='center')
    ax.text(7, -0.15, "Promoters+CREs", horizontalalignment='center')
    ax.text(9, -0.15, "Promoters", horizontalalignment='center')
    ax.text(11, -0.15, "CREs", horizontalalignment='center')
    ax = all_ax[1]
    ax.set_xlim(0, 8)
    ax.set_ylim(0, 3)
